...
describe('v1beta1.FirestoreClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new firestoreModule.v1beta1.FirestoreClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'firestore.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new firestoreModule.v1beta1.FirestoreClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'firestore.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new firestoreModule.v1beta1.FirestoreClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new firestoreModule.v1beta1.FirestoreClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getDocument', () => {
        it('invokes getDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.GetDocumentRequest', ['name']);
    ...
    describe('updateDocument', () => {
        it('invokes updateDocument without error', async () => {
            ...
            request.document ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.UpdateDocumentRequest', ['document', 'name']);
    ...
    describe('deleteDocument', () => {
        it('invokes deleteDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.DeleteDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('beginTransaction', () => {
        it('invokes beginTransaction without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.BeginTransactionRequest', ['database']);
    ...
    describe('commit', () => {
        it('invokes commit without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.CommitRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('rollback', () => {
        it('invokes rollback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.RollbackRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('batchWrite', () => {
        it('invokes batchWrite without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.BatchWriteRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDocument', () => {
        it('invokes createDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.CreateDocumentRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.firestore.v1beta1.CreateDocumentRequest', ['collectionId']);
    ...
    describe('batchGetDocuments', () => {
        it('invokes batchGetDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.BatchGetDocumentsRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchGetDocuments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchGetDocuments as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchGetDocuments without error and gaxServerStreamingRetries enabled', async () => {
            const client = new firestoreModule.v1beta1.FirestoreClient({gaxServerStreamingRetries: true});
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.firestore.v1beta1.BatchGetDocumentsRequest()
            );
    ...
    describe('runQuery', () => {
        it('invokes runQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.RunQueryRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listDocuments', () => {
        it('invokes listDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.ListDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.firestore.v1beta1.ListDocumentsRequest', ['collectionId']);
            request.collectionId = defaultValue2;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&collection_id=${defaultValue2 ?? '' }`;const expectedResponse = [
    ...
    describe('partitionQuery', () => {
        it('invokes partitionQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.PartitionQueryRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listCollectionIds', () => {
        it('invokes listCollectionIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1beta1.ListCollectionIdsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCollectionIds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCollectionIds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
