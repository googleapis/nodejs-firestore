...
describe('v1.FirestoreAdminClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new firestoreadminModule.v1.FirestoreAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'firestore.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new firestoreadminModule.v1.FirestoreAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'firestore.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new firestoreadminModule.v1.FirestoreAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new firestoreadminModule.v1.FirestoreAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createUserCreds', () => {
        it('invokes createUserCreds without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createUserCreds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createUserCreds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createUserCreds without error using callback', async () => {
            ...
            client.innerApiCalls.createUserCreds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createUserCreds(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IUserCreds|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createUserCreds with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createUserCreds = stubSimpleCall(undefined, expectedError);
    ...
    describe('getUserCreds', () => {
        it('invokes getUserCreds without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getUserCreds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getUserCreds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getUserCreds without error using callback', async () => {
            ...
            client.innerApiCalls.getUserCreds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getUserCreds(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IUserCreds|null) => {
        ...
        it('invokes getUserCreds with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getUserCreds = stubSimpleCall(undefined, expectedError);
    ...
    describe('listUserCreds', () => {
        it('invokes listUserCreds without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listUserCreds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listUserCreds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listUserCreds without error using callback', async () => {
            ...
            client.innerApiCalls.listUserCreds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listUserCreds(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IListUserCredsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listUserCreds with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listUserCreds = stubSimpleCall(undefined, expectedError);
    ...
    describe('enableUserCreds', () => {
        it('invokes enableUserCreds without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.enableUserCreds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.enableUserCreds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes enableUserCreds without error using callback', async () => {
            ...
            client.innerApiCalls.enableUserCreds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes enableUserCreds with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.enableUserCreds = stubSimpleCall(undefined, expectedError);
    ...
    describe('disableUserCreds', () => {
        it('invokes disableUserCreds without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.disableUserCreds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.disableUserCreds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes disableUserCreds without error using callback', async () => {
            ...
            client.innerApiCalls.disableUserCreds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes disableUserCreds with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.disableUserCreds = stubSimpleCall(undefined, expectedError);
    ...
    describe('resetUserPassword', () => {
        it('invokes resetUserPassword without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resetUserPassword as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resetUserPassword as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resetUserPassword without error using callback', async () => {
            ...
            client.innerApiCalls.resetUserPassword = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes resetUserPassword with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resetUserPassword = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteUserCreds', () => {
        it('invokes deleteUserCreds without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteUserCreds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteUserCreds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteUserCreds without error using callback', async () => {
            ...
            client.innerApiCalls.deleteUserCreds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteUserCreds with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteUserCreds = stubSimpleCall(undefined, expectedError);
    ...
    describe('getBackup', () => {
        ...
        it('invokes getBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackup(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IBackup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listBackups', () => {
        ...
        it('invokes listBackups without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listBackups(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IListBackupsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createBackupSchedule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBackupSchedule(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IBackupSchedule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBackupSchedules without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listBackupSchedules(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.admin.v1.IListBackupSchedulesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('bulkDeleteDocuments', () => {
        it('invokes bulkDeleteDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.admin.v1.BulkDeleteDocumentsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.bulkDeleteDocuments = stubLongRunningCall(expectedResponse);
            const [operation] = await client.bulkDeleteDocuments(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkDeleteDocuments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkDeleteDocuments as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes bulkDeleteDocuments without error using callback', async () => {
            ...
            client.innerApiCalls.bulkDeleteDocuments = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.bulkDeleteDocuments(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.firestore.admin.v1.IBulkDeleteDocumentsResponse, protos.google.firestore.admin.v1.IBulkDeleteDocumentsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.firestore.admin.v1.IBulkDeleteDocumentsResponse, protos.google.firestore.admin.v1.IBulkDeleteDocumentsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkDeleteDocuments as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteDatabase', () => {
        it('invokes deleteDatabase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.admin.v1.DeleteDatabaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteDatabase = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteDatabase(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDatabase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDatabase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDatabase without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDatabase = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteDatabase(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.firestore.admin.v1.IDatabase, protos.google.firestore.admin.v1.IDeleteDatabaseMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.firestore.admin.v1.IDatabase, protos.google.firestore.admin.v1.IDeleteDatabaseMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDatabase as SinonStub)
                .getCall(0).args[0];
    ...
    describe('restoreDatabase', () => {
        it('invokes restoreDatabase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.admin.v1.RestoreDatabaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes restoreDatabase without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.restoreDatabase(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.firestore.admin.v1.IDatabase, protos.google.firestore.admin.v1.IRestoreDatabaseMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.firestore.admin.v1.IDatabase, protos.google.firestore.admin.v1.IRestoreDatabaseMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.restoreDatabase as SinonStub)
                .getCall(0).args[0];
    ...
    describe('cloneDatabase', () => {
        it('invokes cloneDatabase without error', async () => {
            ...
            client.innerApiCalls.cloneDatabase = stubLongRunningCall(expectedResponse);
            const [operation] = await client.cloneDatabase(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cloneDatabase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cloneDatabase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cloneDatabase without error using callback', async () => {
            ...
            client.innerApiCalls.cloneDatabase = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cloneDatabase(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.firestore.admin.v1.IDatabase, protos.google.firestore.admin.v1.ICloneDatabaseMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.firestore.admin.v1.IDatabase, protos.google.firestore.admin.v1.ICloneDatabaseMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cloneDatabase as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes cloneDatabase with call error', async () => {
            ...
            const expectedHeaderRequestParams = 'database_id=value';
            const expectedError = new Error('expected');
            client.innerApiCalls.cloneDatabase = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes cloneDatabase with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = 'database_id=value';
            const expectedError = new Error('expected');
            client.innerApiCalls.cloneDatabase = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.cloneDatabase(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.cloneDatabase as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCloneDatabaseProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCloneDatabaseProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCloneDatabaseProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCloneDatabaseProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('Path templates', () => {
        ...
        describe('userCreds', async () => {
            ...
            await client.initialize();
            client.pathTemplates.userCredsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.userCredsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('userCredsPath', () => {
                const result = client.userCredsPath("projectValue", "databaseValue", "userCredsValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.userCredsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromUserCredsName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.userCredsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
