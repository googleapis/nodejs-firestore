...
describe('v1.FirestoreClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new firestoreModule.v1.FirestoreClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'firestore.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new firestoreModule.v1.FirestoreClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'firestore.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new firestoreModule.v1.FirestoreClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new firestoreModule.v1.FirestoreClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getDocument', () => {
        ...
        it('invokes getDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDocument(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.v1.IDocument|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes beginTransaction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.beginTransaction(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.v1.IBeginTransactionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('commit', () => {
        ...
        it('invokes commit without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.commit(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.v1.ICommitResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchWrite', () => {
        ...
        it('invokes batchWrite without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchWrite(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.v1.IBatchWriteResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDocument', () => {
        it('invokes createDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1.CreateDocumentRequest', ['parent']);
    ...
    describe('batchGetDocuments', () => {
        ...
        it('invokes batchGetDocuments without error and gaxServerStreamingRetries enabled', async () => {
            const client = new firestoreModule.v1.FirestoreClient({gaxServerStreamingRetries: true});
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.firestore.v1.BatchGetDocumentsRequest()
            );
    ...
    describe('runAggregationQuery', () => {
        it('invokes runAggregationQuery without error', async () => {
            ...
            client.innerApiCalls.runAggregationQuery = stubServerStreamingCall(expectedResponse);
    ...
    describe('write', () => {
        it('invokes write without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.firestore.v1.WriteResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
    ...
    describe('listDocuments', () => {
        it('invokes listDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1.ListDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.firestore.v1.ListDocumentsRequest', ['collectionId']);
            request.collectionId = defaultValue2;
    ...
    describe('partitionQuery', () => {
        it('invokes partitionQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1.PartitionQueryRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes partitionQuery without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.partitionQuery(
                    request,
                    (err?: Error|null, result?: protos.google.firestore.v1.ICursor[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listCollectionIds', () => {
        it('invokes listCollectionIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.firestore.v1.ListCollectionIdsRequest', ['parent']);
            request.parent = defaultValue1;
