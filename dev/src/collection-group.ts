...
import {SPAN_NAME_BATCH_COMMIT, SPAN_NAME_PARTITION_QUERY} from "./telemetry/trace-util";
  ...
  implements firestore.CollectionGroup<AppModelType, DbModelType>
{
  ...
  async *getPartitions(
    ...
    await this._firestore._traceUtil.startActiveSpan(SPAN_NAME_PARTITION_QUERY, async (span) => {
