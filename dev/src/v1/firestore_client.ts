...
export class FirestoreClient {
  ...
  initialize() {
    ...
    const firestoreStubMethods =
        ['getDocument', 'listDocuments', 'updateDocument', 'deleteDocument', 'batchGetDocuments', 'beginTransaction', 'commit', 'rollback', 'runQuery', 'write', 'listen', 'listCollectionIds', 'createDocument'];
  ...
  getDocument(
      ...
      Promise<[
        ...
        protosTypes.google.firestore.v1.IGetDocumentRequest|undefined, {}|undefined
      ]>;
  getDocument(
      request: protosTypes.google.firestore.v1.IGetDocumentRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  updateDocument(
      ...
      Promise<[
        protosTypes.google.firestore.v1.IDocument,
        protosTypes.google.firestore.v1.IUpdateDocumentRequest|undefined, {}|undefined
      ]>;
  updateDocument(
      request: protosTypes.google.firestore.v1.IUpdateDocumentRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  deleteDocument(
      ...
      Promise<[
        ...
        protosTypes.google.firestore.v1.IDeleteDocumentRequest|undefined, {}|undefined
      ]>;
  deleteDocument(
      request: protosTypes.google.firestore.v1.IDeleteDocumentRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  beginTransaction(
      ...
      Promise<[
        ...
        protosTypes.google.firestore.v1.IBeginTransactionRequest|undefined, {}|undefined
      ]>;
  beginTransaction(
      request: protosTypes.google.firestore.v1.IBeginTransactionRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  commit(
      ...
      Promise<[
        ...
        protosTypes.google.firestore.v1.ICommitRequest|undefined, {}|undefined
      ]>;
  commit(
      request: protosTypes.google.firestore.v1.ICommitRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  rollback(
      ...
      Promise<[
        protosTypes.google.protobuf.IEmpty,
        protosTypes.google.firestore.v1.IRollbackRequest|undefined, {}|undefined
      ]>;
  rollback(
      request: protosTypes.google.firestore.v1.IRollbackRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  createDocument(
      ...
      Promise<[
        protosTypes.google.firestore.v1.IDocument,
        protosTypes.google.firestore.v1.ICreateDocumentRequest|undefined, {}|undefined
      ]>;
  createDocument(
      request: protosTypes.google.firestore.v1.ICreateDocumentRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  listDocuments(
      ...
      callback: PaginationCallback<
          protosTypes.google.firestore.v1.IDocument[],
          protosTypes.google.firestore.v1.IListDocumentsRequest|null,
          protosTypes.google.firestore.v1.IListDocumentsResponse>): void;
/**
 * Lists documents.
 *
 * @param {Object} request
 ...
 */
  ...
  listCollectionIds(
      ...
      callback: PaginationCallback<
          string[],
          protosTypes.google.firestore.v1.IListCollectionIdsRequest|null,
          protosTypes.google.firestore.v1.IListCollectionIdsResponse>): void;
/**
