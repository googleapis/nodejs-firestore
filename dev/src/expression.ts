...
export abstract class Expr implements firestore.Expr {
  ...
  //  */
  // bitAnd(other: firestore.Expr): BitAnd;
  //
  // /**
  ...
  //  */
  // bitOr(other: firestore.Expr): BitOr;
  //
  // /**
  ...
  //  */
  // bitXor(other: firestore.Expr): BitXor;
  //
  // /**
  ...
  //  */
  // bitLeftShift(other: firestore.Expr): BitLeftShift;
  //
  // /**
  ...
  // bitLeftShift(other: firestore.Expr | number): BitLeftShift {
  ...
  //  */
  // bitRightShift(other: firestore.Expr): BitRightShift;
  //
  // /**
   ...
   * @return A new `Expr` representing the 'EqAny' comparison.
   */
  eqAny(...others: firestore.Expr[]): EqAny;
   ...
   */
  notEqAny(...others: firestore.Expr[]): NotEqAny;
   ...
   */
  strConcat(...elements: (string | firestore.Expr)[]): StrConcat {
   ...
   */
  replaceFirst(find: string, replace: string): firestore.ReplaceFirst;
   ...
   */
  replaceAll(find: string, replace: string): firestore.ReplaceAll;
   ...
   */
  byteLength(): firestore.ByteLength {
   ...
   */
  logicalMaximum(other: firestore.Expr): firestore.LogicalMaximum;
   ...
   * @return A new {@code Expr} representing the logical maximum operation.
   */
  logicalMaximum(other: any): firestore.LogicalMaximum;
  logicalMaximum(other: any): firestore.LogicalMaximum {
    if (other instanceof Expr) {
   ...
   */
  logicalMinimum(other: firestore.Expr): firestore.LogicalMinimum;
   ...
   * @return A new {@code Expr} representing the logical minimum operation.
   */
  logicalMinimum(other: any): firestore.LogicalMinimum;
  logicalMinimum(other: any): firestore.LogicalMinimum {
    if (other instanceof Expr) {
   ...
   */
  unixMicrosToTimestamp(): firestore.UnixMicrosToTimestamp {
   ...
   */
  timestampToUnixMicros(): firestore.TimestampToUnixMicros {
   ...
   * @return A new {@code Expr} representing the timestamp.
   */
  unixMillisToTimestamp(): firestore.UnixMillisToTimestamp {
   ...
   */
  timestampToUnixMillis(): firestore.TimestampToUnixMillis {
   ...
   * @return A new {@code Expr} representing the timestamp.
   */
  unixSecondsToTimestamp(): firestore.UnixSecondsToTimestamp {
   ...
   */
  timestampToUnixSeconds(): firestore.TimestampToUnixSeconds {
 ...
 * @beta
 */
class ArrayReverse extends Function {
 ...
 * @beta
 */
class EqAny extends Function implements FilterCondition {
  constructor(
    private left: Expr,
    private others: Expr[]
  ) {
 ...
 * @beta
 */
class NotEqAny extends Function implements FilterCondition {
  constructor(
    private left: Expr,
    private others: Expr[]
  ) {
 ...
 * @beta
 */
class Cond extends Function implements FilterCondition {
  constructor(
 ...
 * @beta
 */
class LogicalMaximum extends Function {
  constructor(
    private left: Expr,
    private right: Expr
  ) {
 ...
 * @beta
 */
class LogicalMinimum extends Function {
  constructor(
    private left: Expr,
    private right: Expr
  ) {
 ...
 * @beta
 */
class ToUpper extends Function {
  constructor(private expr: Expr) {
    super('to_upper', [expr]);
  }
}
 ...
 * @beta
 */
class Minimum extends Function implements Accumulator {
  accumulator = true as const;
  constructor(
    private value: Expr,
    private distinct: boolean
 ...
 * @beta
 */
class Maximum extends Function implements Accumulator {
  accumulator = true as const;
  constructor(
    private value: Expr,
    private distinct: boolean
 ...
 * @param element The expression to compare.
 * @param others The values to check against.
 * @return A new {@code Expr} representing the 'NotEqAny' comparison.
 */
