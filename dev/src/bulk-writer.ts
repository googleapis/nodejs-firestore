...
class BulkCommitBatch extends UpdateBuilder<Promise<WriteResult>> {
  wrapResult(res: Promise<WriteResult>): Promise<WriteResult> {
    return res;
  }
...
export class BulkWriter {
   ...
   */
  private batchQueue: UpdateBuilder<Promise<WriteResult>>[] = [];
