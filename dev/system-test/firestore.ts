...
describe('Query class', () => {
  ...
  describe('vector search', () => {
    ...
    it('supports findNearest limits', async () => {
      ...
      expect(
        (
          res.docs[0].get('embedding') as FirebaseFirestore.VectorValue
        ).toArray()
  ...
  describe('WithFieldValue', () => {
    ...
    describe('used as a type', () => {
      class ObjectWrapper<T> {
        withFieldValueT(
          value: FirebaseFirestore.WithFieldValue<T>
        ): FirebaseFirestore.WithFieldValue<T> {
          return value;
        }
  ...
  describe('UpdateData', () => {
    ...
    it('supports optional fields', async () => {
      ...
      const testConverterOptional = {
        toFirestore(
          testObj: FirebaseFirestore.WithFieldValue<TestObjectOptional>
        ) {
          return {...testObj};
        },
    ...
    it('supports union fields', async () => {
      ...
      const testConverterUnion = {
        toFirestore(
          testObj: FirebaseFirestore.WithFieldValue<TestObjectUnion>
        ) {
          return {...testObj};
        },
