...
describe('v1.FirestoreAdminClient', () => {
    ...
    describe('getIndex', () => {
        ...
        it('invokes getIndex with error', async () => {
            ...
            await assert.rejects(async () => { await client.getIndex(request); }, expectedError);
            assert((client.innerApiCalls.getIndex as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteIndex', () => {
        ...
        it('invokes deleteIndex with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteIndex(request); }, expectedError);
            assert((client.innerApiCalls.deleteIndex as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getField', () => {
        ...
        it('invokes getField with error', async () => {
            ...
            await assert.rejects(async () => { await client.getField(request); }, expectedError);
            assert((client.innerApiCalls.getField as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createIndex', () => {
        ...
        it('invokes createIndex with call error', async () => {
            ...
            await assert.rejects(async () => { await client.createIndex(request); }, expectedError);
            assert((client.innerApiCalls.createIndex as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateField', () => {
        ...
        it('invokes updateField with call error', async () => {
            ...
            await assert.rejects(async () => { await client.updateField(request); }, expectedError);
            assert((client.innerApiCalls.updateField as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportDocuments', () => {
        ...
        it('invokes exportDocuments with call error', async () => {
            ...
            await assert.rejects(async () => { await client.exportDocuments(request); }, expectedError);
            assert((client.innerApiCalls.exportDocuments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('importDocuments', () => {
        ...
        it('invokes importDocuments with call error', async () => {
            ...
            await assert.rejects(async () => { await client.importDocuments(request); }, expectedError);
            assert((client.innerApiCalls.importDocuments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listIndexes', () => {
        ...
        it('invokes listIndexes with error', async () => {
            ...
            await assert.rejects(async () => { await client.listIndexes(request); }, expectedError);
            assert((client.innerApiCalls.listIndexes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listFields', () => {
        ...
        it('invokes listFields with error', async () => {
            ...
            await assert.rejects(async () => { await client.listFields(request); }, expectedError);
            assert((client.innerApiCalls.listFields as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
