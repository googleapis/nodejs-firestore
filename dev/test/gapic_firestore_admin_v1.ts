...
describe('v1.FirestoreAdminClient', () => {
    ...
    describe('getField', () => {
        it('invokes getField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateField', () => {
        it('invokes updateField without error', async () => {
            ...
            request.field ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateFieldRequest', ['field', 'name']);
    ...
    describe('exportDocuments', () => {
        it('invokes exportDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportDocumentsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('importDocuments', () => {
        it('invokes importDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportDocumentsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateDatabase', () => {
        it('invokes updateDatabase without error', async () => {
            ...
            request.database ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateDatabaseRequest', ['database', 'name']);
    ...
    describe('listFields', () => {
        it('invokes listFields without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListFieldsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
