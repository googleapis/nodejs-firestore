...
describe('v1beta1.FirestoreClient', () => {
    ...
    describe('getDocument', () => {
        ...
        it('invokes getDocument with error', async () => {
            ...
            assert.rejects(async () => { await client.getDocument(request); }, expectedError);
            assert((client.innerApiCalls.getDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createDocument', () => {
        ...
        it('invokes createDocument with error', async () => {
            ...
            assert.rejects(async () => { await client.createDocument(request); }, expectedError);
            assert((client.innerApiCalls.createDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateDocument', () => {
        ...
        it('invokes updateDocument with error', async () => {
            ...
            assert.rejects(async () => { await client.updateDocument(request); }, expectedError);
            assert((client.innerApiCalls.updateDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteDocument', () => {
        ...
        it('invokes deleteDocument with error', async () => {
            ...
            assert.rejects(async () => { await client.deleteDocument(request); }, expectedError);
            assert((client.innerApiCalls.deleteDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listDocuments', () => {
        ...
        it('invokes listDocuments with error', async () => {
            ...
            assert.rejects(async () => { await client.listDocuments(request); }, expectedError);
            assert((client.innerApiCalls.listDocuments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listCollectionIds', () => {
        ...
        it('invokes listCollectionIds with error', async () => {
            ...
            assert.rejects(async () => { await client.listCollectionIds(request); }, expectedError);
            assert((client.innerApiCalls.listCollectionIds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
