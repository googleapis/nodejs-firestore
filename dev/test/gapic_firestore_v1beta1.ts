...
describe('v1beta1.FirestoreClient', () => {
    ...
    describe('updateDocument', () => {
        it('invokes updateDocument without error', async () => {
            ...
            request.document ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateDocumentRequest', ['document', 'name']);
    ...
    describe('beginTransaction', () => {
        it('invokes beginTransaction without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BeginTransactionRequest', ['database']);
    ...
    describe('commit', () => {
        it('invokes commit without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CommitRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('rollback', () => {
        it('invokes rollback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RollbackRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('batchWrite', () => {
        it('invokes batchWrite without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchWriteRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDocument', () => {
        it('invokes createDocument without error', async () => {
            ...
            const defaultValue2 =
              getTypeDefaultValue('CreateDocumentRequest', ['collectionId']);
    ...
    describe('batchGetDocuments', () => {
        it('invokes batchGetDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchGetDocumentsRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('runQuery', () => {
        it('invokes runQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RunQueryRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listDocuments', () => {
        it('invokes listDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListDocumentsRequest', ['collectionId']);
            request.collectionId = defaultValue2;
    ...
    describe('partitionQuery', () => {
        it('invokes partitionQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PartitionQueryRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listCollectionIds', () => {
        it('invokes listCollectionIds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListCollectionIdsRequest', ['parent']);
            request.parent = defaultValue1;
